...
export default function ReferralBanner() {
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className="relative overflow-hidden bg-gradient-to-br from-purple-600 via-pink-500 to-purple-700 rounded-3xl shadow-2xl"
    >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            <div className="space-y-6 text-white">
              ...
              <h2 className="text-4xl md:text-5xl font-playfair font-light">
                Love Your Haircut?
                <br />
                <span className="text-purple-100">Share the Experience!</span>
              </h2>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link
                  href="/referrals"
                  className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-white text-purple-600 rounded-full font-medium hover:shadow-xl transition-all hover:scale-105"
                >
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  >
                    ...
                    <p className="text-xs text-purple-100">{item.subtitle}</p>
                  </motion.div>
                ))}
              </div>
              ...
              >
                <p className="text-purple-100 text-sm mb-2">Share with up to</p>
                <p className="text-5xl font-bold text-white">10</p>
                <p className="text-purple-100 text-sm mt-2">friends</p>
              </motion.div>
            </div>
          </div>
        </div>
