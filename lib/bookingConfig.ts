...
export const SERVICES: Service[] = [
  ...
  },
  {
    ...
    price: 85,
    duration: 120,
    description: 'Full colour, highlights, balayage, colour corrections',
    requiresDeposit: true,
    depositAmount: 30,
  },
  {
    ...
    price: 150,
    duration: 180,
    description: 'Complete transformation with colour and precision cut',
    requiresDeposit: true,
    depositAmount: 50,
  },
  {
    ...
    price: 35,
    duration: 45,
    description: 'Perfect for special occasions and maintenance between cuts',
    requiresDeposit: false,
    depositAmount: 0,
  },
];
